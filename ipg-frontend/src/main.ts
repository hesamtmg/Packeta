...
// the @font-face block in App.vue). Importing latin/latin-ext only here and
// declaring our own corrected Arabic-subset faces there keeps every
...
import '@fontsource/vazirmatn/latin-ext-800.css';
