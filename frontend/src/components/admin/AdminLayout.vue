...
// Keeps the nav (and every route guard downstream) in sync with the
// account's current permissions without requiring a fresh login — a
// super-admin editing this admin's sections takes effect on their next
