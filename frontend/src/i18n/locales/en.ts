export default {
  ...
  admin: {
    ...
    admins: {
      ...
      readOnlyHint: 'Only super admins can promote/demote admins or change their panel sections.',
      ...
      sectionsCount: '{granted}/{total} sections',
      permissionsHeading: 'Panel sections',
      permissionsSave: 'Save sections',
      permissionsSaved: 'Sections updated.',
      permissionsFailed: 'Failed to update sections',
