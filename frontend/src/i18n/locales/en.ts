export default {
  ...
  admin: {
    ...
    installments: {
      ...
      colActions: 'Actions',
      actionZarinpal: 'Send ZarinPal link',
      actionRepository: 'Absorb from repository',
      actionManual: 'Manual settlement',
      manualDescriptionPlaceholder: 'How was this settled? (bank transfer ref, cash receipt, etc.)',
      manualDescriptionRequired: 'A description of how this was settled is required',
      manualSubmit: 'Confirm settlement',
